...
def obs_to_bh(
    ...
    d = (np.sqrt(r_obs * r_obs + a * a) - z) * sinθ_obs - y * cosθ_obs
...
def bh_to_obs(
    ...
    return (
        u,
        (R - r_obs) * sinθ_obs * cosθ_obs - v * cosθ_obs + z * sinθ_obs,
        (R * sinθ_obs * sinθ_obs + r_obs * cosθ_obs * cosθ_obs) - v * sinθ_obs - z * cosθ_obs,
    )
